...
const ARDB_BASE = 'https://ardb.app/static';
    ...
    const savedTheme = getVersionedStore<string | null>('theme', null);
    ...
    function getNeededState() {
        return getVersionedStore<string[]>(NEEDED_KEY, []);
    }
    ...
    const savedSource = getVersionedStore<string | null>('arcraided-source', null);
